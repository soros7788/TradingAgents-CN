#!/usr/bin/env python3
"""
Excel Formula Recalculation Script (Standalone)
Recalculates all formulas in an Excel file using LibreOffice.

Standalone version — does not depend on TRAE office.soffice module.
Works on Linux (GitHub Actions) and macOS.
"""
...
def get_soffice_env():
    """Return environment for LibreOffice — standalone version"""
    env = os.environ.copy()
    # Ensure HOME is set (needed for LibreOffice profile)
    if 'HOME' not in env:
